...
public class ImageViewAdapter extends RecyclerView.Adapter<ImageViewAdapter.InnerHolder> {
    ...
    public void onBindViewHolder(@NonNull final InnerHolder holder, int position) {
        ...
        if (mSelectedItem.contains(imageItme)) {
            ...
            checkBox.setButtonDrawable(holder.itemView.getContext().getDrawable(R.drawable.check));
            cover.setVisibility(View.VISIBLE);
        } else {
            //如果未添加进去了，设置CheckBox可选，取消阴影，取消勾选样式
            checkBox.setChecked(true);
            checkBox.setButtonDrawable(holder.itemView.getContext().getDrawable(R.drawable.itemtwo));
        ...
        image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mSelectedItem.contains(imageItme)) {
                    ...
                    checkBox.setChecked(true);
                    checkBox.setButtonDrawable(holder.itemView.getContext().getDrawable(R.drawable.picture));
                    cover.setVisibility(View.GONE);
                } else {
                    //对可选最大值进行一个判断
